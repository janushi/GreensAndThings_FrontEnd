...
//          alert(response);
         ...
         else if(($.trim(response))=='congratulations')
          {
            alert("Now enter the verification code sent to your email id");
             window.location.href='mail_contact_forgot_password.php';
          }
          else
          {
             alert("email not registered");
...
<form class="md-float-material"  role="form" method="post" action="#" id="forgotpass" data-parsley-validate enctype="multipart/form-data">
...
<input type="email" class="form-control" placeholder="Your Email Address" name="email_id" id="user_login" autocomplete="username" />
<span class="md-line"></span>
</div>
<div class="row">
<div class="col-md-12">
<button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"  name="submit" value="Reset password">Submit</button>
</div>
</div>
<hr />
