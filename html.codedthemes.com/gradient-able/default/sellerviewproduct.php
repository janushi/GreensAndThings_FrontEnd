      ...
      $(".delete").click(function(e) {                
        ...
        // alert(qrystrng);
         var retval=confirm("Are you sure you want to delete? ");
                ...
                type: "POST",
                url: "sellercheckdeleteproduct.php",             
                 data:qrystrng,
               dataType: "html",  //expect html to be returned                
                 success: function(response){
                alert(response)
                         window.location.href="sellerviewproduct.php";
                //return true;
                          }   
});
            }
...
<?php
$isa=1;
$qry = "SELECT * FROM orders WHERE isDeleted=0 AND uid=".$uid." ";
        // echo $qry;
...
<?php $qry1 = "SELECT * FROM category WHERE cid=".$row['cid']." ";
                    // echo $qry;
...
<?php } ?>
<td><a href="sellercheckupdateproduct.php?<?php echo "id=".$row['oid']?>"><button type="button" class="btn btn-warning"  style="border-radius: 50%; width:5px !important;"><i class="ti-na" style="color:white; margin-left:-5px !important;"></li></button></a></td>
<td><button type="button" class="btn btn-danger delete" style="border-radius: 50%; width:5px !important;" href="#" id="<?php echo $row['oid']; ?>" ><i class="ti-trash" style="color:white; margin-left:-5px !important;"></li></button></td>
